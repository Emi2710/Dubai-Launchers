export function refusEmail() {
  return `
      ...
      <head>
        ...
        <title>Dubai Launchers: Vos documents ont été refusés</title>
      </head>
          ...
          <div style="padding:20px 40px; text-align:center;">
            <h1 style="font-size:32px; font-weight:bold; margin:30px 0 20px; line-height:1.2; color:white;">
             ...
             <p style="font-size:18px; color:white; margin-bottom:30px; line-height:1.5;">
              Vos documents ont été refusés après évaluation dans votre espace Dubai Launchers. Veuillez vous connecter afin d'en connaître la raison et soumettre vos documents à nouveau.
            </p>
