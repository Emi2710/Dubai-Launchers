export function ajoutEmail() {
  return `
      ...
      <head>
        ...
        <title>Dubai Launchers: Nouveau document ajouté dans votre espace</title>
      </head>
        ...
        <div style="max-width:600px; margin:0 auto; background-color:#1a1b3a; min-height:100%;">
          ...
          <div style="padding:20px 40px; text-align:center;">
            <h1 style="font-size:32px; font-weight:bold; margin:30px 0 20px; line-height:1.2; color:white;">
              Nouveau document dans votre espace
            </h1>

            <p style="font-size:18px; color:white; margin-bottom:30px; line-height:1.5;">
              Un nouveau document a été ajouté dans votre espace Dubai Launchers. Pensez à vous connecter afin de le consulter.
            </p>
